...
projects/      Individual analyses/experiments (see _example/, nyc_taxis/, titanic/, flights/, diamonds/, sms_spam/, air_quality/, adult_income/, sunspots/, bbc_news/, store_sales/, bank_marketing/, mammography/)
...
| Feature | `ds.features` | `add_datetime_features`, `add_lagged_features`, `text_features`, `one_hot_encode`, `collapse_categories` |
